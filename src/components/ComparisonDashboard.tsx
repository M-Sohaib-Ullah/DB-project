      ...
      <div className="p-6 text-[#E0E0E0]">
        ...
        <div className="grid grid-cols-2 gap-4 md:gap-6 mb-8">
          <div className="relative aspect-square md:aspect-[16/9] rounded border border-white/10 overflow-hidden bg-white/5">
            <img src={heroA.image_url} className="w-full h-full object-contain object-center grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-700" referrerPolicy="no-referrer" />
          ...
          <div className="relative aspect-square md:aspect-[16/9] rounded border border-white/10 overflow-hidden bg-white/5">
            <img src={heroB.image_url} className="w-full h-full object-contain object-center grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-700" referrerPolicy="no-referrer" />
            <div className="absolute inset-0 bg-gradient-to-t from-[#0A0A0A] via-transparent to-transparent opacity-90" />
